...
public class EntryProgram {
	...
	public static void main(String[] args) {
		ChessPiecePosition chessPiecePosition = new ChessPiecePosition();
	...
	static ChessBoardBlockPiece getCurrentPiecePosition(ChessPiecePosition chessGame, String currentPlayer) {
		Scanner scanner = new Scanner(System.in);
		String input;
	...
	static ChessBoardLocation splitRowAndColumn(String rowAndColumnInput) {
